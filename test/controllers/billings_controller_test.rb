...
class BillingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create billing" do
    assert_difference('Billing.count') do
      post billings_url, params: { billing: { cost: @billing.cost, description: @billing.description, mycase_id: @billing.mycase_id, payment: @billing.payment } }
    end
  ...
  test "should update billing" do
    patch billing_url(@billing), params: { billing: { cost: @billing.cost, description: @billing.description, mycase_id: @billing.mycase_id, payment: @billing.payment } }
