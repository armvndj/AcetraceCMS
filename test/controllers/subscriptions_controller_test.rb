...
class SubscriptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create subscription" do
    assert_difference('Subscription.count') do
      post subscriptions_url, params: { subscription: { amount: @subscription.amount, amount: @subscription.amount, customer_code: @subscription.customer_code, customer_id: @subscription.customer_id, expires_on: @subscription.expires_on, lawfirm_id: @subscription.lawfirm_id, paid_at: @subscription.paid_at, plan_code: @subscription.plan_code, reference: @subscription.reference } }
    end
  ...
  test "should update subscription" do
    patch subscription_url(@subscription), params: { subscription: { amount: @subscription.amount, amount: @subscription.amount, customer_code: @subscription.customer_code, customer_id: @subscription.customer_id, expires_on: @subscription.expires_on, lawfirm_id: @subscription.lawfirm_id, paid_at: @subscription.paid_at, plan_code: @subscription.plan_code, reference: @subscription.reference } }
